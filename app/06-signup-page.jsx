...
// Sign-up page
// WHY: For new users. Same flow as signin (passwordless email)
// The "signup" and "signin" flows are identical in passwordless auth
// NextAuth handles user creation automatically
...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Same as signin - NextAuth handles both
      // It creates the user on first signup, logs them in on return
