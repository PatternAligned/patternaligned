  ...
  return (
    <div className="bg-black min-h-screen text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-white mb-12">How much risk are you comfortable with?</p>
        ...
        <div className="space-y-4">
          {risks.map((risk) => (
            ...
            >
              ...
              <p className="text-white group-hover:text-black/70 mb-3">{risk.description}</p>
              <p className="text-sm text-white italic group-hover:text-black/60">{risk.behavior}</p>
            </button>
          ))}
        </div>
